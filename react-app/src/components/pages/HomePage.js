...
function HomePage() {
  ...
  return ( recentFlights &&
    <div className='flex-1 mt-20 bg-background1 bg-cover bg-center font-noto'>
      <div className='p-3 flex divide-x-2 bg-background h-full md:w-max mx-auto'>
        <div className='w-1/2 px-7 flex flex-col items-center'>
